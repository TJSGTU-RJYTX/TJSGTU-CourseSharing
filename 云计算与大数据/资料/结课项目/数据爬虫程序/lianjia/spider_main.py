...
class SpiderMain():
    ...
    def craw(self,root_url):
        """爬虫入口函数"""
        areas = {
                "heping":1, "nankai":1, "hexi":1,
                "hebei":1,"hedong":1, "hongqiao":1,
                "xiqing":1, "beichen":1,"dongli":1,
                "jinnan":1, "tanggu":1, "kaifaqutj":1,
                "wuqing":1, "binhaixinqu":1, "baodi":1,
                "jizhou":1, "haihejiaoyuyuan":1, "jinghai":1,
                "ninghe":1,
                }
        ...
        for area,pg_sum in areas.items():
            for num in range(1, pg_sum+1):
                #1.1 拼接页面地址: https://tj.lianjia.com/ershoufang/gulou/pg2/
...
if __name__ == "__main__":
    #设定爬虫入口URL
    root_url = "https://tj.lianjia.com/ershoufang/"
    #初始化爬虫对象
