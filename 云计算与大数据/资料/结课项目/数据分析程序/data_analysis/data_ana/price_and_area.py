...
ax.set_title("天津各区域二手房平均单价",fontsize=18)
...
ax.set_title("天津各区域二手房单价箱线图",fontsize=18)
...
ax.set_title("天津各区域二手房平均建筑面积",fontsize=18)
...
ax1.set_title("天津各区域二手房平均单价",fontsize=18)
ax2 = fig.add_subplot(2,1,2)
ax2.set_ylabel("建筑面积(㎡)",fontsize=14)
ax2.set_title("天津各区域二手房平均建筑面积",fontsize=18)
...
ax.set_title("天津各区域二手房房源数量",fontsize=18)
...
ax = fig.add_subplot(111)
ax.set_ylabel("单价(元/平米)",fontsize=14)
ax.set_title("天津二手房单价最高Top20",fontsize=18)
unitprice_top["unitPriceValue"].plot(kind="barh",fontsize=12)
plt.savefig('../data_ana/picture/price_top20.jpg')
# plt.show()
...
fig = plt.figure(figsize=(12,7))
ax = fig.add_subplot(111)
ax.set_title("天津二手房单价与建筑面积散点图",fontsize=18)
...
ax.set_xlabel("建筑面积(㎡)",fontsize=14)
ax.set_ylabel("单价(元/平米)",fontsize=14)
# plt.savefig('../data_ana/picture/total_squaer_dot2.jpg')
# plt.show()
