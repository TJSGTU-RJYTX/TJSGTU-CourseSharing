...
ax.set_title("天津二手房房屋户型占比情况",fontsize=18)
count_fwhx.plot(kind="pie",cmap=plt.cm.rainbow,autopct="%3.1f%%",fontsize=12)
# plt.savefig('../data_ana/picture/house_rate.jpg')
# plt.show()
...
fig = plt.figure(figsize=(9,9))
ax = fig.add_subplot(111)
ax.set_title("天津二手房装修占比情况",fontsize=18)
...
fig = plt.figure(figsize=(9,9))
ax = fig.add_subplot(111)
ax.set_title("天津二手房建筑类型占比情况",fontsize=18)
